...
class MobileNetV3Large(tf.keras.Model):
    ...
    def call(self, inputs, training=None, mask=None):
        ...
        c2 = self.bneck3(x, training=training)
        x = self.bneck4(c2, training=training)
        x = self.bneck5(x, training=training)
        c3 = self.bneck6(x, training=training)
        x = self.bneck7(c3, training=training)
        ...
        c4 = self.bneck12(x, training=training)
        x = self.bneck13(c4, training=training)
        x = self.bneck14(x, training=training)
        c5 = self.bneck15(x, training=training)
